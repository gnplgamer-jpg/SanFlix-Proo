        ...
        {!checkoutPlan ? (
          ...
          <div className="w-full flex flex-col items-center justify-center py-6">
            ...
            <div className="bg-white p-4 rounded-3xl mb-6 shadow-[0_0_40px_rgba(96,187,70,0.2)]">
               <img src="https://i.ibb.co/0pb2rLWm/esewa-qr.jpg" alt="eSewa QR Code" className="w-48 h-48 object-contain rounded-2xl" onError={(e) => { e.currentTarget.src = 'https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg'; }} />
            </div>
